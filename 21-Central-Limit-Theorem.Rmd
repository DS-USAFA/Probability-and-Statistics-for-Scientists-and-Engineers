...
3) Explain how the $t$ distribution relates to the normal distribution and where we use it, and describe the impact on the shape of the distribution when the parameters are changed.   
