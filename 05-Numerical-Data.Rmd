...
```{r box2-fig,echo=FALSE,fig.cap="Box plots of the original character count data and two modified data sets, one where the outlier at 64,401 is dropped and one where its value is increased."}
p1 <- email50$num_char
p2 <- p1[-which.max(p1)]
p3 <- p1
p3[which.max(p1)] <- 150
