...
1) Know and properly use the terminology of a hypothesis test: *null hypothesis*, *alternative hypothesis*, *test statistic*, *p-value*, *randomization test*, *permutation test*, *one-sided test*, *two-sided test*, *statistically significant*, *significance level*, *type I error*, *type II error*, *false positive*, *false negative*, *null distribution*, and *sampling distribution*.     
